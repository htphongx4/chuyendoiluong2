  ...
  computed: {
    ...
    outlinedButtonClass() {
      ...
      switch (this.color) {
        case "primary":
          className =
            "tw-bg-white tw-text-primary tw-rounded-sm tw-capitalize tw-font-bold tw-border-primary tw-border tw-border-solid disabled:tw-bg-white hover:tw-bg-grey-50";
          break;
        case "secondary":
          className =
